...
import SalarioMaternidadePage from './pages/SalarioMaternidadePage';
import BpcLoasAutismoPage from './pages/BpcLoasAutismoPage';
      ...
      <WhatsAppModalProvider>
        <Router>
          <Routes>
            ...
            <Route path="/salario-maternidade-inss" element={<SalarioMaternidadePage />} />
            <Route path="/bpc-loas-autismo-inss" element={<BpcLoasAutismoPage />} />
